...
// Dummy data (replace with your actual newArrivals array)
const newArrivals = [
  {
    id: 1,
    ...
    <section className="py-16 relative">
      <div className="container mx-auto text-center mb-10">
        ...
        <p className="text-gray-600">
          Discover fresh arrivals curated just for your style.
        </p>
      </div>
      ...
      <button
        ...
        className="absolute left-2 top-[50%] z-10 transform -translate-y-1/2 p-2 rounded-full border bg-white text-black shadow disabled:bg-gray-200 disabled:text-gray-400 disabled:cursor-not-allowed"
      >
      ...
      <button
        ...
        className="absolute right-2 top-[50%] z-10 transform -translate-y-1/2 p-2 rounded-full border bg-white text-black shadow disabled:bg-gray-200 disabled:text-gray-400 disabled:cursor-not-allowed"
      >
      ...
      <div
        ...
        className={`container mx-auto flex gap-4 sm:gap-6 px-4 overflow-x-auto scroll-smooth transition-all duration-300 
        ...
        {newArrivals.map((product) => (
          ...
          >
            <img
              ...
              draggable="false"
            />
            <div className="absolute bottom-0 left-0 right-0 bg-white/80 backdrop-blur-md text-black p-4 rounded-b-lg">
